...
/** @brief A protocol exposed by operations that allow resumption
 ...
 @define{AGSResumableTaskJob.h, ArcGIS}
 @since 10.2.2
 */
...
/** The type of resumable task. Possible values include the following string constants
 ...
 @li @c AGSResumableTaskJobTypeGenerateGeodatabase
 @li @c AGSResumableTaskJobTypeSyncGeodatabase
 @li @c AGSResumableTaskJobTypeExportTileCacheSizeEstimate
 @li @c AGSResumableTaskJobTypeExportTileCache
