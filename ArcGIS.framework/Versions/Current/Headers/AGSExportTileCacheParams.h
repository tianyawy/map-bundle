...
/** @brief Parameters for @c AGSExportTileCacheTask to create and download a tile cache
 
 This class holds parameters describing the tile cache that should be returned by
 @c AGSExportTileCacheTask#exportTileCacheWithParameters:downloadFolderPath:useExisting:status:completion:
 
 @define{AGSExportTileCacheParams.h, ArcGIS}
 @agssince{10.2, 10.2}
 */
...
/**
 ...
 You can inspect @c AGSExportTileCacheTask#tiledServiceInfo to find out 
 the levels available 
 @see @c AGSTileInfo#lods
 @agssince{10.2, 10.2}
 */
