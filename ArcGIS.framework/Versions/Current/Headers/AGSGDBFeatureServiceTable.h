...
/** @brief A dataset from an ArcGIS Map or Feature service
...
You can also query the data based on SQL expressions and/or spatial relationships.
 ...
 This class, when used in conjunction with @c AGSFeatureTableLayer to display data on a map, is meant to eventually replace
 @c AGSFeatureLayer because it can handle temporary network outages while still allowing you to work with the data that
