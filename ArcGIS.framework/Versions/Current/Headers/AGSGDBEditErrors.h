...
/** @brief Edit errors encountered during sync.
 ...
 @define{AGSGDBEditErrors, ArcGIS}
 @since 10.2.2
*/
@interface AGSGDBEditErrors : NSObject

/** An array of @c AGSGDBFeatureEditError objects representing the errors related to any feature edits.
 @since 10.2.2
 */
@property (nonatomic, copy, readonly) NSArray *featureErrors;

/** An array of @c AGSGDBFeatureEditError objects representing the errors related to any attachment edits.
 @since 10.2.2
 */
