...
/** @brief Manages attachments belonging to a feature
 ...
 @see @concept{working-with-the-attachment-manager.htm, Working with the Attachment Manager}
...
/** Adds an attachment.
 ...
 @agssince{2.0, 10.2}
 @deprecated Deprecated at 10.2.2 due to memory issues with large files. Use @c AGSAttachmentManager#addAttachmentWithUIImagePickerControllerInfoDictionary:completion instead.
 */
...
/** @brief A delegate of @c AGSAttachmentManager
 ...
 performed by @c AGSAttachmentManager are completed. An instance of the class must then be set as @c AGSAttachmentManager#delegate .
