...
/** Notification that indicates that an @c AGSPortal failed to load.
 @agssince{10.2, 10.2}
 */
AGS_EXTERN NSString *const AGSPortalDidFailToLoadNotification;

/** Notification that indicates that an @c AGSPortal successfully found items.
 @agssince{10.2, 10.2}
 */
AGS_EXTERN NSString *const AGSPortalDidFindItemsNotification;

/** Notification that indicates that an @c AGSPortal failed to find items.
 @agssince{10.2, 10.2}
 */
AGS_EXTERN NSString *const AGSPortalDidFailToFindItemsNotification;

/** Notification that indicates that an @c AGSPortal successfully found groups.
 @agssince{10.2, 10.2}
 */
AGS_EXTERN NSString *const AGSPortalDidFindGroupsNotification;

/** Notification that indicates that an @c AGSPortal failed to find groups.
 @agssince{10.2, 10.2}
 */
...
/** @brief A delegate of @c AGSPortal
 ...
 class must then be set as @c AGSPortal#delegate .
