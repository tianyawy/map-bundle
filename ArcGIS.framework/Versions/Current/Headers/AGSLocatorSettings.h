...
/** @brief Performance optimization settings for @c AGSLocator.
 
 This class holds settings to optimize the @c AGSLocator for use with local address locator datasets (*.loc files)
 
 @define{AGSLocatorSettings.h, ArcGIS}
 @agssince{10.2, 10.2}
 */
