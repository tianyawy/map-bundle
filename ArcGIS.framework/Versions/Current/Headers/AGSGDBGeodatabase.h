...
/** @brief A geodatabase on disk
 ...
 @see @c AGSGDBSyncTask to download the geodatabase from a sync enabled ArcGIS Feature service.
 @define{AGSGDBGeodatabase.h, ArcGIS}
 @agssince{10.2, 10.2} 
 */
...
/** An array of @c AGSGDBFeatureTable objects representing the geographic datasets
 in this geodatabase.
 @since 10.2
 */
...
/** Retrieve the dataset that corresponds to a particular layerID in the
 ...
 @return @c AGSGDBFeatureTable representing the dataset
 @since 10.2
 */
...
/** Indicates whether the geodatabase has been edited.
 @return @c YES if edited, else @c NO
 @since 10.2
 */
-(BOOL)hasLocalEdits;
