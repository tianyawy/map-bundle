...
/** Notification to indicate the task loaded @c AGSGDBSyncTask#featureServiceInfo
 @since 10.2
 */
AGS_EXTERN NSString *const AGSGDBSyncTaskDidLoadNotification;

/** Notification to indicate the task failed to load @c AGSGDBSyncTask#featureServiceInfo
 @since 10.2
 */
...
/** @brief A task to download a sync-enabled geodatabase
 ...
 @define{AGSGDBSyncTask.h, ArcGIS}
 @agssince{10.2, 10.2}
 */
...
/** Register the local geodatabase as a new sync-enabled geodatabase with the service. The geodatabase can then sync changes with the service indepedently of any other copies of the geodatabase that may exist.
...
/** Unregister a local sync-enabled
 geodatabase from the service. The geodatabase will not be able to sync with the service hereafter.
...
/**
 ...
 @agssince{10.2, 10.2}
 @see @c AGSTask#checkStatusForAllResumableTaskJobsWithCompletion: to monitor job status even when the app is in the background
 @see @c AGSRequest#allowsCellularAccessForDownloads to prevent downloading geodatabase over cellular network
 */
...
/**
 ...
 @agssince{10.2, 10.2}
 @note Uploading local edits requires a standard license for deployment. See @c AGSGDBSyncParameters#syncDirection.
 */
...
/** @brief A category with debugging options for @c AGSGDBSyncTask
 
 Debugging options when sync operations on @c AGSGDBSyncTask fail mysteriously.
