...
/** Gets or sets the minimum resolution that can be zoomed in to on the map.
 ...
 @since 10.2.2
 @see @c #resolutionForScale: and @c #scaleForResolution: to convert between map resolution and scale.
 */
...
/** Zooms map by a factor. Anchor Point is in screen coordinates of the map view.
 ...
 @param anchorPoint Point in screen coordinates around which to zoom. This is ignored if the @c AGSLocationDisplay::autoPanMode is @c AGSLocationDisplayAutoPanModeNavigation or @c AGSLocationDisplayAutoPanModeCompassNavigation in which case map zooms around the location symbol.
...
/** Zooms the map to the given resolution
 ...
 @param centerPoint to zoom around. If nil and @c AGSLocationDisplay::autoPanMode is @c AGSLocationDisplayAutoPanModeNavigation or @c AGSLocationDisplayAutoPanModeCompassNavigation, the map zooms around the location symbol.
...
/** Zooms the map to the given scale
 ...
 @param centerPoint to zoom around. If nil and the #c AGSLocationDisplay::autoPanMode is @c AGSLocationDisplayAutoPanModeNavigation or @c AGSLocationDisplayAutoPanModeCompassNavigation, the map zooms around the location symbol.
 If the locationDisplay is not in those modes, but the centerPoint is nil, map zooms around its center. 
 @param animated flag indicating whether to animate the zoom action
 @agssince{2.1, 10.2}
