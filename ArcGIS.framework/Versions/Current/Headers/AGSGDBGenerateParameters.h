...
/** @brief Parameters to download a sync-enabled geodatabase
 ...
 Instances of this class represent parameters that will be sent to the @c AGSGDBSyncTask#generateGeodatabaseWithParameters:downloadFolderPath:useExisting:status:completion: method.
...
/** Array of AGSGDBLayerQuery objects specifiying how to filter
 ...
 @c AGSGDBLayerQuery#useGeometry to @c NO.
 @agssince{10.2, 10.2}
 */
...
/** Specifies whether the geodatabase to be generated should be configured to sync with the originating service as a whole or on per
 ...
 Defaults to AGSGDBSyncModelPerGeodatabase unless @c #initWithFeatureServiceInfo: is used to initialize the object defaults best suited for the given geodatabase.
 @agssince{10.2, 10.2}
 @see @c AGSGDBSyncTask#syncGeodatabase:params:status:completion:
 */
