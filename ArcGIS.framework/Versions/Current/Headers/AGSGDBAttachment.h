...
/** Initialize a geodatabase attachment with @p image and named @p name.
 The image will be converted to jpg. If you want to preserve your image type then use @c #initWithData:name:contentType:
...
/** Returns a geodatabase attachment created with @p image and named @p name.
 The image will be converted to jpg. If you want to preserve your image type then use @c #attachmentWithData:name:contentType:
 @param image used to create the attachment
 @param name of the attachment
 @since 10.2.2
 */
...
/** Returns a geodatabase attachment for the item chosen in a UIImagePickerController
 ...
 @since 10.2
 @deprecated Deprecated at 10.2.2 due to memory issues with large files. Use @c AGSGDBAttachment#attachmentWithUIImagePickerControllerInfoDictionary:completion instead.
 */
