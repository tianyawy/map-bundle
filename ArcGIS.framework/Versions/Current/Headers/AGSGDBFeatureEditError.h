...
/** @brief An error generated from synchronizing an edited feature in a sync enable geodatabase.
 ...
 @define{AGSGDBFeatureEditError.h, ArcGIS}
 @since 10.2.2
 */
...
/** The name of the table to which the feature belongs.
 @since 10.2.2
 @see @c AGSGDBGeodatabase#featureTableForLayerName: to retrieve the particular @c AGSGDBFeatureTable this name refers to.
 */
