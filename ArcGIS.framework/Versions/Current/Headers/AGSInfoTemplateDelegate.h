...
/** @brief A template describing the contents of @c AGSCallout for a graphic.
 ...
 @agssince{1.0, 10.2}
 @deprecated Deprecated at 10.2. Use @c AGSCalloutDelegate or @c AGSLayerCalloutDelegate instead.
...
/** Title text to be displayed in the callout.
 ...
 @deprecated Deprecated at 10.2. Use @c AGSCalloutDelegate#callout:willShowForFeature:layer:mapPoint: or @cAGSLayerCalloutDelegate#callout:willShowForFeature:layer:mapPoint: instead.
 @agssince{1.0, 10.2}
 */
