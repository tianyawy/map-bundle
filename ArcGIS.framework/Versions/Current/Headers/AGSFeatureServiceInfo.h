...
/** @brief Information about an ArcGIS Feature service
 ...
 An instance of the class is available from @c AGSGDBSyncTask#featureServiceInfo once the task has finished loading. It may be used to instantiate an @c AGSGDBGenerateParameters which will set up some convenient defaults.
 
 @define{AGSFeatureServiceInfo.h, ArcGIS}
 @agssince{10.2, 10.2} 
 */
