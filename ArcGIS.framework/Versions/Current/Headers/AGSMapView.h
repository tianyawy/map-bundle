...
/** @brief A View component to display maps.
 ...
 The component informs its @c #layerDelegate and @c #touchDelegate  whenever certain events take place and
 ...
 fully functional. The <code>mapView:didClickAtPoint:mapPoint:features:</code> method on @c AGSMapViewTouchDelegate is
 ...
 @see @concept{adding-a-map.htm, Creating a Map}
 @agssince{1.0, 10.2}
...
/** @brief A delegate of @c AGSMapView.
 ...
 @define{AGSMapView.h, ArcGIS}
 @deprecated Deprecated at 10.2. Use @c AGSCalloutDelegate instead.
 @agssince{1.8, 10.2}
 */
...
/** Asks the delegate whether to show a callout when the user taps the location display.
 ...
 @deprecated Deprecated at 10.2. Use @c AGSCalloutDelegate#callout:willShowForLocationDisplay: instead.
 @agssince{1.8, 10.2}
 */
...
/** Asks delegate whether to show callout for a graphic that has been tapped on.
 ...
 @deprecated Deprecated at 10.2. Use @c AGSCalloutDelegate#callout:willShowForFeature:layer:mapPoint: instead.
 @agssince{1.8, 10.2}
 */
...
/** Tells the delegate that a callout will be dismissed.
 @deprecated Deprecated at 10.2. Use @c AGSCalloutDelegate#calloutWillDismiss: insetad.
 @agssince{2.0, 10.2}
 */
...
/** Tells the delegate that the callout was dismissed.
 @deprecated Deprecated at 10.2. Use @c AGSCalloutDelegate#calloutDidDismiss: instead.
 @agssince{1.8, 10.2}
 */
...
/** @brief A delegate of @c AGSMapView.
 ...
 class must then be set as @c AGSMapView#touchDelegate .
...
/** Tells the delegate the map was single-tapped at specified location.
 ...
 @deprecated Deprecated at 10.2. Use @c AGSMapViewTouchDelegate#mapView:didClickAtPoint:mapPoint:features: instead.
 @agssince{1.8, 10.2}
 */
...
/** Tells the delegate that a point on the map was tapped and held at specified
 ...
 @param graphics Graphics from all graphics layers in the map that intersect or contain 
 the location. The dictionary contains layer name (key) : @c AGSGraphic array (value)
 @deprecated Deprecated at 10.2. Use @c AGSMapViewTouchDelegate#mapView:didTapAndHoldAtPoint:mapPoint:features: instead.
 @agssince{1.8, 10.2}
 */
...
/** Tells the delegate that the user moved his finger while tapping and holding on the map.
 ...
 @param graphics Graphics from all graphics layers in the map that intersect or contain 
 the location. The dictionary contains layer name (key) : @c AGSGraphic array (value)
 @deprecated Deprecated at 10.2. Use @c AGSMapViewTouchDelegate#mapView:didMoveTapAndHoldAtPoint:mapPoint:features: instead.
 @agssince{1.8, 10.2}
 */
...
/** Tells the delegate that a tap and hold event has ended.
 ...
 @param graphics Graphics from all graphics layers in the map that intersect or contain 
 the location. The dictionary contains layer name (key) : @c AGSGraphic array (value)
 @deprecated Deprecated at 10.2. Use @c AGSMapViewTouchDelegate#mapView:didEndTapAndHoldAtPoint:mapPoint:features: instead.
 @agssince{1.8, 10.2}
 */
