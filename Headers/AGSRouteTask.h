...
/** @brief A task to compute routes.
 ...
 @see @concept{routing-task.htm, Using a Route Task}
 @see @sample{e4fa8dafbe83475882ac9c0fd0a075c7, Routing }
 @see @sample{ca98b8fe79e34d14b3451789498d1a70, Routing Offline}
...
/** @brief A delegate of @c AGSRouteTask.
 ...
 instance of the class must then be set @c AGSRouteTask#delegate .
