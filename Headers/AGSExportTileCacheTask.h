...
/** Notification to indicate the task loaded @c AGSExportTileCacheTask#tiledServiceInfo
 @since 10.2
 */
AGS_EXTERN NSString *const AGSExportTileCacheTaskDidLoadNotification;

/** Notification to indicate the task failed to load @c AGSExportTileCacheTask#tiledServiceInfo
 @since 10.2
 */
...
/** @brief A task to download a basemap tiles
 ...
 @define{AGSExportTileCacheTask.h, ArcGIS}
 @agssince{10.2, 10.2}
 */
...
/** The block that is executed when the task loads or fails to load the @c #tiledServiceInfo.
 @agssince{10.2, 10.2}
 */
...
/**
 ...
 @param status A block that will be invoked when @c AGSExportTileCacheTask#estimateSizeWithParameters:status:completion: has a new status to report.
...
/**
 ...
 @see @c AGSRequest#allowsCellularAccessForDownloads to prevent downloading tile packages over cellular network
 */
