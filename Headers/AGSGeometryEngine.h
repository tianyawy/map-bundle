...
/** @brief An engine to perform geometric operations
 ...
 @c AGSGeometryEngine is functionally similar to @c AGSGeometryServiceTask except that it does not rely on a remote ArcGIS Geometry Service.
...
/** Creates a buffer polygon at the specified distance around the given geometry.
 ...
 @agssince{1.8, 10.2}
 @see @c AGSSpatialReference#convertValue:fromUnit: and @c AGSSpatialReference#convertValue:toUnit: to convert values between different units
 */
...
/** Returns a point for a given MGRS coordinate string
 ...
 @agssince{2.2, 10.2}
 @deprecated Deprecated at 10.2. Use @c AGSPoint#pointFromMGRSString:withSpatialReference: instead.
 */
...
/** Returns a Military Grid Reference System (MGRS) coordinate for the given point. For example : 4Q 612341 2356781
 ...
 @agssince{2.2, 10.2}
 @deprecated Deprecated at 10.2. Use @c AGSPoint#MGRSStringWithNumDigits:rounding:addSpaces: instead.
 */
