...
/** @brief Parameters for @c AGSGeometryEngine#geodesicSectorWithParameters: 
 
  This class holds options for the @c AGSGeometryEngine#geodesicSectorWithParameters: operation.
