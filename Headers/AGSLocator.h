...
/** @brief A locator to geocode and reverse-geocode addresses.
 ...
 The default locator created using @c AGSLocator#locator uses the [World Geocode Service](http://resources.arcgis.com/en/help/arcgis-online-geocoding-rest-api/#/Overview_of_the_World_Geocoding_Service/02q000000008000000/) on ArcGIS Online. The service covers 100+ countries and is
 ...
 @see @concept{locator-task.htm, Using a Locator}
 @see @sample{c1e9abdacf524c2f99d39fbac14b3e0d, Geocoding }
 @see @sample{bee879b4cf5a4e04aad1bf28baf040e1, Geocoding Offline}
...
/** Executes an operation to retrieve service info. The @c #delegate will be notified 
 when the operation completes or if an error is encountered..
 
 @return <code>NSOperation</code> for current request.
 @see @c AGSLocatorDelegate#locator:operation:didFetchLocatorInfo: , method on delegate for success
 @see @c AGSLocatorDelegate#locator:operation:didFailFetchLocatorInfo: , method on delegate for failure
 @agssince{10.2, 10.2}
 */
...
/** Executes a geocoding operation to find location candidates for various types of inputs -
 ...
 @note This feature is only available with the default locator created using @c AGSLocator#locator
...
/** @brief A delegate of @c AGSLocator.
 ...
 class must then be set as @c AGSLocator#delegate .
...
/** Tells the delegate that @c AGSLocator retrieved locator info for the operation @c AGSLocator#fetchLocatorInfo
 @param locator The locator called to retrieve service info.
 @param op <code>NSOperation</code> that performed the task.
 @param results Instance of @c AGSLocatorInfo.
 @agssince{10.2, 10.2}
 */
- (void)locator:(AGSLocator*)locator operation:(NSOperation*)op didFetchLocatorInfo:(AGSLocatorInfo*)locatorInfo;

/** Tells the delegate that @c AGSLocator encountered an error for the operation @c AGSLocator#fetchLocatorInfo
 @param locator The locator called to retrieve service info.
 @param op <code>NSOperation</code> that performed the task.
 @param error Information about the error returned by the service.
 @agssince{10.2, 10.2}
