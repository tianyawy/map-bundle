...
/** @brief A class to facilitate the creation of an @c AGSWMTSLayer from a WMTS Server map service
...
/** @brief A protocol that must be adopted in order create an @c AGSWMTSLayer
 ...
 to a WMTS service. An instance of this class must be set as @c AGSWMTSInfo#delegate .
...
/** This method tells the delegate if the WMTSInfo object failed to load
 ...
 @agssince{10.1.1, 10.2}
 @deprecated Deprecated at 10.2. Use @c AGSWMTSInfoDelegate#wmtsInfo:didFailToLoad instead.
 */
