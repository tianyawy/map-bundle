...
/** @brief A cursor for query results
 ...
 You need to call @c #reset and then @c #next to advance the cursor to the first result.
 
 @define{AGSGDBQueryResultCursor, ArcGIS}
 @since 10.2
 */
...
/** Advance the cursor to the next result.
 You need to call @c #reset and then @c #next to advance the cursor to the first result.
 @return @c YES, if cursor was advanced, @NO if no more results
 @since 10.2
 */
-(BOOL)next;
