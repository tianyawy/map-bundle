...
/** @brief Group of methods to perform calculations on array of geometry objects
 
 This category contains methods of @c AGSGeometryServiceTask that perform calculations on an
