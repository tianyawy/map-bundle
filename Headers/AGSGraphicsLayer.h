...
/**
 Specifies how the @c AGSGraphicsLayer renders it's content.
...
/** The symbol to use for drawing selected graphics. If this is not specified, @c #selectionColor is used.
 @agssince{10.1.1, 10.2}
 @see @c #selectionColor
 */
...
/** The color to use for drawing a halo around selected graphics. Default is cyan.
 Only used if @c #selectionSymbol is not specified.
 @agssince{10.1.1, 10.2}
 */
...
/** Selects or un-selects the graphic.
 ...
 @param graphic
 @agssince{10.1.1, 10.2}
 @see @c #selectionColor @c #selectionSymbol for changing how selected graphics are displayed
 @see @c AGSGraphicsLayer#clearSelection to clear selection
 */
