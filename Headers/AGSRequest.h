...
/** @brief Wrapper class to request data from a URL
 ...
 @see @c AGSJSONRequestOperation to fetch JSON asynchronously
 @see @c AGSImageRequestOperation to fetch an image asynchronously
 @agssince{1.0, 10.2}
 */
