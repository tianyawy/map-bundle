...
/** @brief A layer based on an ArcGIS Server map/feature service layer.
 ...
 @see @concept{feature-layer.htm, ArcGIS Feature Layer}
...
/** This is an easy way to set the info template delegate for all graphics in the 
 ...
 <code>nil</code>.
 @deprecated Deprecated at 10.2. Use @c AGSHitTestable#calloutDelegate instead.
 @agssince{1.0, 10.2}
 */
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
...
/** Executes a query against the service layer pointed by the URL. The query 
 ...
 @agssince{1.0, 10.2}
 @see @c AGSFeatureLayerQueryDelegate#featureLayer:operation:didQueryFeaturesWithFeatureSet: , method on #queryDelegate for success
 @see @c AGSFeatureLayerQueryDelegate#featureLayer:operation:didFailQueryFeaturesWithError:  , method on #queryDelegate for failure
 */
...
/** Executes a query against the service layer pointed by the URL. The query 
 ...
 @return The operation performing the query.
 @agssince{1.0, 10.2}
 @see @c AGSFeatureLayerQueryDelegate#featureLayer:operation:didQueryObjectIdsWithResults: , method on #queryDelegate for success
 @see @c AGSFeatureLayerQueryDelegate#featureLayer:operation:didFailQueryObjectIdsWithError: , method on #queryDelegate for failure
 */
...
/** Executes a query against the service layer pointed by the URL. The query 
 ...
 The @c #queryDelegate will be notified when the operation completes or if an error
 is encountered.
 @param query Specifies the criteria for the query.
 @return The operation performing the query.
 @agssince{1.8, 10.2}
 @see @c AGSFeatureLayerQueryDelegate#featureLayer:operation:didQueryFeatureCountWithResult: , method on @c #queryDelegate for success
 @see @c AGSFeatureLayerQueryDelegate#featureLayer:operation:didFailQueryFeatureCountWithError: , method on @c #queryDelegate for failure
*/
...
/**Executes a query against the service layer pointed by the URL. The query 
 ...
 @return The operation performing the query.
 @agssince{1.0, 10.2}
 @see @c AGSFeatureLayerQueryDelegate#featureLayer:operation:didQueryRelatedFeaturesWithResults: , method on @c #queryDelegate for success
 @see @c AGSFeatureLayerQueryDelegate#featureLayer:operation:didFailQueryRelatedFeaturesWithError: , method on @c #queryDelegate for failure
 */
...
/** Selects features based on the specified query. Selected features are 
 symbolized using @c #selectionSymbol if available, otherwise using the layer's
 ...
 @agssince{1.0, 10.2}
 @see @c AGSFeatureLayerQueryDelegate#featureLayer:operation:didSelectFeaturesWithFeatureSet: , method on @c #queryDelegate for success
 @see @c AGSFeatureLayerQueryDelegate#featureLayer:operation:didFailSelectFeaturesWithError: , method on @c #queryDelegate for failure
 @see @c AGSGraphicsLayer#selectedFeatures for a list of currently selected features
 @see @c #selectionColor @c #selectionSymbol for changing how selected features are displayed
 @see @c AGSFeatureLayer#clearSelection to clear selection
 */
...
/**
 ...
 @agssince{1.8, 10.2}
 @deprecated Deprecated at 10.1.1. Use @c AGSFeatureLayer#setSelected:forGraphic: instead.
 */
...
/** @brief A delegate of @c AGSFeatureLayer.
 ...
 @c AGSFeatureLayer#queryDelegate .
